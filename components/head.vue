...
<template>
    <header class=" flex items-center gap-3 fixed top-3 p-2 w-full justify-center z-50 px-5">
        ...
        <button @click="change_status" class=" bg-red-700/30 backdrop-blur-sm rounded-full p-4 relative">
